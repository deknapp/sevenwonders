...
WonderCard::WonderCard(std::string _name, int _age, int _minPlayers, int _points) :
						 Card("blue", _name, _age, _minPlayers), points(_points) {}

WonderCard::WonderCard(std::string _name, std::string buyCard, int _age, int _minPlayers, int _points) :
						 Card("blue", _name, buyCard, _age, _minPlayers), points(_points) {}

WonderCard::WonderCard(std::string _name, std::string buyCard, 
...
WonderCard::WonderCard(std::string _name, 
						 int wood, int stone, int brick, int ore, 
						 int _age, int _minPlayers, int _points):
