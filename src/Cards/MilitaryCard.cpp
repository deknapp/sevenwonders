...
MilitaryCard::MilitaryCard(std::string _name, 
						 ...
						 Card("military", _name, wood, stone, brick, ore, _age, _minPlayers) {}

MilitaryCard::MilitaryCard(std::string _name, std::string buyCard,
						 int wood, int stone, int brick, int ore, 
						 int _age, int _minPlayers):
						 Card("military", _name, wood, stone, brick, ore, buyCard, _age, _minPlayers) {}
						
MilitaryCard::MilitaryCard(std::string _name, 
						int wood, int stone, int brick, int ore, int glass, int carpet, int paper, int _age, 
						int _minPlayers) :
						Card("military", _name, wood, stone, brick, ore, glass, carpet, paper, _age, _minPlayers) {}
